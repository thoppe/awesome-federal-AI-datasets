...
| [:green_circle:](data/datasets/HHS_NIH_bibliometric-publication-citation-graph-links.yaml) | [HHS](https://www.hhs.gov/) | [NIH](https://www.nih.gov/) | [Bibliometric publication citation graph links](https://support.icite.nih.gov/hc/en-us/articles/9513563045787-Bulk-Data-and-API) |
...
| [:red_circle:](data/datasets/GSA__regulations-gov-federal-rulemaking-process.yaml) | [GSA](https://www.gsa.gov/) | [TTS](https://tts.gsa.gov/) | [Regulations.gov, Federal rulemaking process](https://open.gsa.gov/api/regulationsgov/) |
